'''
@Author: your name
@Date: 2019-11-09 10:10:35
@LastEditTime: 2019-11-09 10:41:18
@LastEditors: Please set LastEditors
@Description: In User Settings Edit
@FilePath: \pactise_opencv_python\Removefog.py
'''
import cv2
import numpy as np
...
if __name__ == '__main__':
    m = deHaze(cv2.imread('15.png') / 255.0) * 255
    cv2.imwrite('16.png', m)
